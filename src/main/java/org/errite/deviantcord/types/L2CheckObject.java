...
public class L2CheckObject {
    ...
    private ServerTextChannel givenTextChannel;

    private boolean isMature;


    public void setInputServer(Server givenServer){inputServer = givenServer;}
    ...
    public void setGivenTextChannel(ServerTextChannel tc){givenTextChannel = tc;}

    public ServerTextChannel getGivenTextChannel() {
        return givenTextChannel;
    }
